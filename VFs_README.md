NEXUS is compatible with and accelerated by the DPDK library.
* NEXUS has been tested with dpdk version 21.11.1lts with both Intel 40 GbE and Mellanox 100 GbE NICs

## DPDK installation
  * [DPDK](http://core.dpdk.org/download/) version 21.11.1 lts
    Intel 40 GbE and Mellanox 100 GbE NICs in NEXUS.
  * It is required that you enable hugepage support and run NEXUS under sudo permissions (LD_LIBRARY_PATH=${LD_LIBRARY_PATH}).
    <pre>
 ...
 * **NOTE** If you are trying to run virtual functions, please make sure the BIOS is providing enough MMIO space.
