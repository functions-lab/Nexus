...
#ifndef AGORA_WORKERSW_H_
#define AGORA_WORKERSW_H_
...
class AgoraWorkerSW : public WorkerBase {
 public:
  explicit AgoraWorkerSW(Config* cfg, MacScheduler* mac_sched, Stats* stats,
