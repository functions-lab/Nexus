...
#include "agora_worker-multiCell-sc.h"
#include "agora_worker-multiCell-sw.h"
#include "agora_worker-multiCell-scsw.h"
...
class Agora {
 ...
 private:
  ...
  std::unique_ptr<BufferBase> agora_memory_;
  ...
  FrameInfoS2 frame_tracking_S2_{0, 0};

  std::unique_ptr<MessageInfo> message_;
  std::unique_ptr<MessageInfoS2> message_S2_;
