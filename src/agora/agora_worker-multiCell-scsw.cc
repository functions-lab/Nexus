...
AgoraWorkerSCSW::AgoraWorkerSCSW(Config* cfg, MacScheduler* mac_sched, Stats* stats,
  ...
  tid =
      0 + (int)config_
              ->bbdev_id_1();  // starts with 0 but has only one thread (master)
...
AgoraWorkerSCSW::~AgoraWorkerSCSW() {}

void AgoraWorkerSCSW::InitializeWorker() {
...
void AgoraWorkerSCSW::RunWorker() {
