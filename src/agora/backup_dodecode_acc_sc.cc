/**
 * @file dodecode_acc_org.cc
 * @brief This is a back up file where there is no mapping feature to solve the undeterminstic behavior for Savannah-mc when running ACC100
 */
