...
AgoraBufferS2::AgoraBufferS2(Config* const cfg)
    : config_(cfg),
...
AgoraBufferS2::~AgoraBufferS2() { FreeTables(); }

void AgoraBufferS2::AllocateTables() {
  // Uplink
...
void AgoraBufferS2::AllocatePhaseShifts() {
