...
#ifndef AGORA_WORKERS4_H_
#define AGORA_WORKERS4_H_
...
class AgoraWorkerS4 : public WorkerBase {
 public:
  explicit AgoraWorkerS4(Config* cfg, MacScheduler* mac_sched, Stats* stats,
