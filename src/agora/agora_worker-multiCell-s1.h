...
#ifndef AGORA_WORKERS1_H_
#define AGORA_WORKERS1_H_
...
class AgoraWorkerS1 : public WorkerBase {
 public:
  explicit AgoraWorkerS1(Config* cfg, MacScheduler* mac_sched, Stats* stats,
