...
#ifndef AGORA_WORKERS3_H_
#define AGORA_WORKERS3_H_
...
class AgoraWorkerS3 : public WorkerBase {
 public:
  explicit AgoraWorkerS3(Config* cfg, MacScheduler* mac_sched, Stats* stats,
