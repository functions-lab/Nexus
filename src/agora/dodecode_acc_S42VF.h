...
#ifndef DODECODE_ACCS42VF_H_
#define DODECODE_ACCS42VF_H_
...
class DoDecode_ACCS42VF : public Doer {
 public:
  DoDecode_ACCS42VF(
 ...
 private:
  ...
  struct rte_bbdev_dec_op* ref_dec_op[NUM_VF][64];
  struct rte_bbdev_dec_op* ops_deq[NUM_VF][64];
