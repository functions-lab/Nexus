...
#include "agora_worker-multiCell-s1.h"
...
AgoraWorkerS1::AgoraWorkerS1(Config* cfg, MacScheduler* mac_sched, Stats* stats,
...
AgoraWorkerS1::~AgoraWorkerS1() { JoinThreads(); }

void AgoraWorkerS1::CreateThreads() {
  ...
  for (size_t i = 0; i < config_->WorkerThreadNum(); i++) {
    workers_.emplace_back(&AgoraWorkerS1::WorkerThread, this, i);
  }
}

void AgoraWorkerS1::JoinThreads() {
...
void AgoraWorkerS1::WorkerThread(int tid) {
