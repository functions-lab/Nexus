...
AgoraWorkerSC::AgoraWorkerSC(Config* cfg, MacScheduler* mac_sched, Stats* stats,
...
AgoraWorkerSC::~AgoraWorkerSC() {}

void AgoraWorkerSC::InitializeWorker() {
