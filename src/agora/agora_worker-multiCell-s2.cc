...
#include "agora_worker-multiCell-s2.h"
...
AgoraWorkerS2::AgoraWorkerS2(Config* cfg, MacScheduler* mac_sched, Stats* stats,
...
AgoraWorkerS2::~AgoraWorkerS2() { JoinThreads(); }

void AgoraWorkerS2::CreateThreads() {
  ...
  for (size_t i = 0; i < config_->WorkerThreadNum(); i++) {
    workers_.emplace_back(&AgoraWorkerS2::WorkerThread, this, i);
  }
}

void AgoraWorkerS2::JoinThreads() {
...
void AgoraWorkerS2::WorkerThread(int tid) {
