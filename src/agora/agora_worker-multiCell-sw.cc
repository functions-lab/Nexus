...
#include "agora_worker-multiCell-sw.h"
...
AgoraWorkerSW::AgoraWorkerSW(Config* cfg, MacScheduler* mac_sched, Stats* stats,
...
AgoraWorkerSW::~AgoraWorkerSW() { JoinThreads(); }

void AgoraWorkerSW::CreateThreads() {
  ...
  for (size_t i = 0; i < config_->WorkerThreadNum(); i++) {
    workers_.emplace_back(&AgoraWorkerSW::WorkerThread, this, i);
  }
}

void AgoraWorkerSW::JoinThreads() {
...
void AgoraWorkerSW::WorkerThread(int tid) {
