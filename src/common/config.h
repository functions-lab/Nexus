...
class Config {
 public:
  ...
  inline std::string ACC100Addr_1() const { return this->acc100_addr_1_; }
  inline uint8_t bbdev_id_1() const { return this->bbdev_id_1_; }
  inline std::string Solution() const { return this->solution_; }
